...
namespace Unity.YYSX
{
    ...
    /// in the <see cref="UnityEngine.InputSystem.InputActionProperty"/>, as opposed to a reference to an action externally defined
    /// in an <see cref="UnityEngine.InputSystem.InputActionAsset"/>, the action will automatically be enabled and disabled by this
    ...
    /// </remarks>
    [Serializable]
    public class TrackedPoseDriver_YYSX : MonoBehaviour, ISerializationCallbackReceiver
    {
        /// <summary>
        ...
        /// <seealso cref="UnityEngine.InputSystem.InputSystem.onAfterUpdate"/>
        public enum UpdateType
        {
            ...
            /// </remarks>
            /// <seealso cref="InputUpdateType.BeforeRender"/>
            /// <seealso cref="UnityEngine.XR.InputDevice.updateBeforeRender"/>
            BeforeRender,
        }
