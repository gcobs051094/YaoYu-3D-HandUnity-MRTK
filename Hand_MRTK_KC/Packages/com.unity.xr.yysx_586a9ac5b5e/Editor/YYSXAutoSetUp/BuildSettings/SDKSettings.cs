...
public class SDKSettings : EditorWindow {
    ...
    void OnGUI() {
        ...
        if ( CheckSettings() == true ) {
            ...
            window?.Close();
            Close();
            YYSXAutoSetUp.DisplayWhenSettingsOK();
            return;
        }
    ...
    static void PlayerWindow() {
        ...
        GUILayout.Label("activeBuildTarget:Android");
        if ( EditorUserBuildSettings.activeBuildTarget != BuildTarget.Android ) {
            ...
            GUIStyle styleApply = new GUIStyle("LargeButton");
            styleApply.alignment = TextAnchor.MiddleCenter;
            styleApply.fixedHeight = 20;
            styleApply.fixedWidth = 180;
            if ( GUILayout.Button("Fix", styleApply) ) {
            ...
            GUILayout.Label("OK", styleApplied);
        }
        EditorGUILayout.EndHorizontal();
        ...
        GUILayout.Label("colorSpace:Gamma");
        ...
        GUILayout.Label("ScriptingBackend:IL2CPP");
        ...
        GUILayout.Label("targetArchitectures:ARM64");
