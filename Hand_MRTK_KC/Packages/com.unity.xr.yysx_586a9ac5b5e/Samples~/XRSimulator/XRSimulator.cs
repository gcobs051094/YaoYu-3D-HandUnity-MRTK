...
namespace UnityEngine
{
    ...
    public class XRSimulator :MonoBehaviour {
        ...
        void ProcessPoseInput() {
            ...
            m_HMDState.leftEyeRotation = m_HMDState.deviceRotation;
            m_HMDState.leftEyePosition = m_HMDState.devicePosition;
            m_HMDState.rightEyeRotation = m_HMDState.deviceRotation;
            m_HMDState.rightEyePosition = m_HMDState.devicePosition;
