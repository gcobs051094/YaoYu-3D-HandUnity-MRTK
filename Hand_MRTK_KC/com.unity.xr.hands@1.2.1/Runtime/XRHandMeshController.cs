...
namespace UnityEngine.XR.Hands
{
    ...
    public class XRHandMeshController : MonoBehaviour
    {
        ...
        public XRHandSkeletonDriver driver;
        ...
        {
            Debug.Log(Time.frameCount+" wangcq327 --- OnTrackingChanged:"+isTracked+"|"+ m_XRHandTrackingEvents.handedness);
        ...
        void UpdateRendererVisibility()
        {
            ...
            { //Debug.Log("wangcq327 --- ============> track   |"+ m_XRHandTrackingEvents.handedness);
            ...
            {
                //Debug.Log("wangcq327 --- ============> Losttrack   |" + m_XRHandTrackingEvents.handedness);
                m_HandMeshRenderer.enabled = false;
