...
namespace UnityEngine.XR.Hands
{
        ...
        : SubsystemWithProvider<XRHandSubsystem, XRHandSubsystemDescriptor, XRHandSubsystemProvider>
    {
        ...
        bool isTrackLeftHand = false;
        bool isTrackRightHand = false;
        bool isOnlyOneHand = false;
        ...
        public virtual unsafe UpdateSuccessFlags TryUpdateHands(UpdateType updateType)
        {
            ...
            if (isOnlyOneHand &&  m_LeftHand.isTracked && m_RightHand.isTracked ) {
                if ( isTrackRightHand ) {
                    m_LeftHand.isTracked = false;
                    wasLeftHandTracked = m_LeftHand.isTracked;
                } else if ( isTrackLeftHand ) {
                    m_RightHand.isTracked = false;
                    wasRightHandTracked = m_RightHand.isTracked;
                } else {
                    m_LeftHand.isTracked = false;
                    wasLeftHandTracked = m_LeftHand.isTracked;
                }
            ...
            isTrackLeftHand = m_LeftHand.isTracked;
            isTrackRightHand = m_RightHand.isTracked;


            //Debug.Log("XRHandSubsystem TryUpdateHands :" + wasLeftHandTracked +"|"+ success+"|"+ m_LeftHand.isTracked);
